  ...
  const services = [
    {
      ...
      key: "binance_ws",
      description: "Real-time trade stream — primary live feed",
      isPrimary: true,
    ...
    },
    {
      ...
      key: "bybit_ws",
      description: "Real-time trade stream — backup live feed",
      isPrimary: true,
    ...
    },
    {
      name: "CoinGecko",
      key: "coingecko",
      description: "24h stats, market cap, price change",
      isPrimary: false,
    ...
    },
    {
      name: "Kraken",
      key: "kraken",
      description: "Cross-exchange price validation",
      isPrimary: false,
    ...
    },
    {
      name: "CoinMarketCap",
      key: "coinmarketcap",
      description: "Market cap rankings & volume data",
      isPrimary: false,
